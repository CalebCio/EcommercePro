                ...
                <div class="div_center">
                    ...
                    <form action="{{url('/add_product')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="div_design">
                            ...
                            <input class="text_color" type="number" name="dis_price" placeholder="Enter discount price">
                        </div>

                        <div class="div_design">
                            <label>Product Quantity :</label>
                            <input class="text_color" type="number" name="quantity" min="0" placeholder="Enter quantity" required="">
                        </div>

                        <div class="div_design">
                            <label>Product Cartegory :</label>
                            <select class="text_color" name="cartegory" required="">
                                <option value="" selected>Add a cartegory here</option>
